...
export default function RetailerSignupForm() {
  ...
  const updateFormProgress = () => {
    const totalFields = Object.keys(formData).length - 1; // Excluding confirmPassword
    ...
    >
      <div className="max-w-lg w-full bg-white shadow-2xl rounded-lg p-8">
        ...
        <p className="text-center text-gray-500 mb-6">
          Join our marketplace and get access to wholesale products from
          verified suppliers.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {[
            ...
            {
              label: "Retail Business Name",
              name: "retailBusinessName",
              type: "text",
            },
